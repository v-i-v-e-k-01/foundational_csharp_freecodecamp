...
{
    int[] changedCash = new int[cashTill.Length];
    for (int i = 0; i < cashTill.Length; i++)
    {
        changedCash[i] = cashTill[i];
    }
    changedCash[3] += twenties;
    changedCash[2] += tens;
    changedCash[1] += fives;
    changedCash[0] += ones;
    ...
    while ((changeNeeded > 19) && (changedCash[3] > 0))
    {
        changedCash[3]--;
        changeNeeded -= 20;
    ...
    while ((changeNeeded > 9) && (changedCash[2] > 0))
    {
        changedCash[2]--;
        changeNeeded -= 10;
    ...
    while ((changeNeeded > 4) && (changedCash[1] > 0))
    {
        changedCash[1]--;
        changeNeeded -= 5;
    ...
    while ((changeNeeded > 0) && (changedCash[0] > 0))
    {
        changedCash[0]--;
        changeNeeded -= 1;
