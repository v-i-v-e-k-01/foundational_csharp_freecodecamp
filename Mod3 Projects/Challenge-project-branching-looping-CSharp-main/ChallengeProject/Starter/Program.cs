...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                else
                {
                    ...
                    if (ourAnimals[i, 2] == "Age: " || ourAnimals[i, 2] == "Age: ?")
                    {
                        do
                        {
                            Console.WriteLine($"Enter age for id {ourAnimals[i, 0]}");
                            readResult = Console.ReadLine();
                            if (readResult != null)
                            {
                                validEntry = int.TryParse(readResult, out varNum);
                                if (validEntry)
                                {
                    ...
                    if (ourAnimals[i, 3] == "Nickname: ")
                    {
                        do
                        {
                            Console.WriteLine($"Enter the Nickname for id {ourAnimals[i, 0]}");
                            readResult = Console.ReadLine();
                    ...
                    if (ourAnimals[i, 5] == "Personality: " || ourAnimals[i, 5] == "Personality: \"tbd\"")
                    {
                        do
                        {
                            Console.WriteLine($"Enter the Personality Description of pet {ourAnimals[i, 0]}");
                            readResult = Console.ReadLine();
                            if (readResult != null && readResult!="")
                            {
                                validEntry = true;
            ...
            Console.WriteLine("Age, Nickname, physical description and personality fields are complete for all of our friends. ");
            Console.WriteLine("Press the Enter key to continue");
            readResult = Console.ReadLine();
            break;
